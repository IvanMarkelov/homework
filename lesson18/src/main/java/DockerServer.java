...
public class DockerServer implements Runnable {
    ...
    final static private String pathToResources = "." + File.separator + "lesson18" +
            File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator;
    final static private String INDEX_PAGE = pathToResources + "index.html";
    final static private String PAGE_404 = pathToResources + "404.html";

    private Socket clientSocket;

    public DockerServer(Socket clientSocket) {
    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                DockerServer dockerServer = new DockerServer(serverSocket.accept());
                Thread thread = new Thread(dockerServer);
                thread.start();
            }
        } catch (IOException e) {
            e.printStackTrace();
